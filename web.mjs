...
;
	($.$story_app_stats) = class $story_app_stats extends ($.$mol_list) {
		rows(){
			return [(this.Player()), (this.Group())];
		}
		player_name(){
			return "";
		}
	...
	($mol_mem(($.$story_app_stats.prototype), "Player"));
	($mol_mem(($.$story_app_stats.prototype), "Group"));
...
;
	($.$story_app_auth) = class $story_app_auth extends ($.$mol_list) {
		rows(){
	...
	($mol_mem(($.$story_app_auth.prototype), "name"));
	($mol_mem(($.$story_app_auth.prototype), "Name"));
	($mol_mem(($.$story_app_auth.prototype), "login"));
	($mol_mem(($.$story_app_auth.prototype), "valid"));
	($mol_mem(($.$story_app_auth.prototype), "Login"));
	($mol_mem(($.$story_app_auth.prototype), "registration"));
	($mol_mem(($.$story_app_auth.prototype), "Registration"));
	($mol_mem(($.$story_app_auth.prototype), "demo"));
	($mol_mem(($.$story_app_auth.prototype), "Demo"));
	($mol_mem(($.$story_app_auth.prototype), "Login_form"));
...
;
	($.$story_app_heroes) = class $story_app_heroes extends ($.$mol_page) {
		title(){
			return "Герои";
		}
		body(){
			return [(this.Party()), (this.Heroes_list())];
		}
		Party(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("Отряд");
		...
		Heroes_list(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ((this.heroes_list()));
			return obj;
		}
	};
	($mol_mem(($.$story_app_heroes.prototype), "Party"));
	($mol_mem_key(($.$story_app_heroes.prototype), "Hero_name"));
	($mol_mem_key(($.$story_app_heroes.prototype), "Skill_text"));
	($mol_mem_key(($.$story_app_heroes.prototype), "Skill_name"));
	($mol_mem_key(($.$story_app_heroes.prototype), "Skill_level"));
	($mol_mem_key(($.$story_app_heroes.prototype), "Skill_description"));
	($mol_mem_key(($.$story_app_heroes.prototype), "Skill"));
	($mol_mem_key(($.$story_app_heroes.prototype), "Skills"));
	($mol_mem_key(($.$story_app_heroes.prototype), "Weapons_text"));
	($mol_mem_key(($.$story_app_heroes.prototype), "Weapon_name"));
	($mol_mem_key(($.$story_app_heroes.prototype), "Weapon_level"));
	($mol_mem_key(($.$story_app_heroes.prototype), "Weapon_type"));
	($mol_mem_key(($.$story_app_heroes.prototype), "Weapon_params"));
	($mol_mem_key(($.$story_app_heroes.prototype), "Weapon"));
	($mol_mem_key(($.$story_app_heroes.prototype), "Weapons"));
	($mol_mem_key(($.$story_app_heroes.prototype), "Hero"));
	($mol_mem(($.$story_app_heroes.prototype), "Heroes_list"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $story_app_heroes.prototype, "heroes", null);
        $$.$story_app_heroes = $story_app_heroes;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));

;
	($.$story_app_battle_field) = class $story_app_battle_field extends ($.$mol_list) {
		rows(){
			return [
				(this.Turn()), 
				(this.Field()), 
		...
		Cell(id){
			...
			(obj.attr) = () => ({"active": (this.cell_active(id)), "type": (this.cell_type(id))});
			(obj.title) = () => ((this.cell_title(id)));
			(obj.click) = (next) => ((this.click_cell(id, next)));
			return obj;
		}
		x_list(id){
		...
		SkillPanel(){
			const obj = new this.$.$mol_row();
			(obj.sub) = () => ([(this.Skill_1()), (this.Skill_2())]);
			return obj;
		}
		EndTurn(){
			const obj = new this.$.$mol_button_major();
	...
	($mol_mem(($.$story_app_battle_field.prototype), "Turn"));
	($mol_mem_key(($.$story_app_battle_field.prototype), "cell_active"));
	($mol_mem_key(($.$story_app_battle_field.prototype), "cell_type"));
	($mol_mem_key(($.$story_app_battle_field.prototype), "click_cell"));
	($mol_mem_key(($.$story_app_battle_field.prototype), "Cell"));
	($mol_mem_key(($.$story_app_battle_field.prototype), "X"));
	($mol_mem(($.$story_app_battle_field.prototype), "Y"));
	($mol_mem(($.$story_app_battle_field.prototype), "Field"));
	($mol_mem(($.$story_app_battle_field.prototype), "Skills"));
	($mol_mem(($.$story_app_battle_field.prototype), "click_skill"));
	($mol_mem(($.$story_app_battle_field.prototype), "Skill_1"));
	($mol_mem(($.$story_app_battle_field.prototype), "Skill_2"));
	($mol_mem(($.$story_app_battle_field.prototype), "SkillPanel"));
	($mol_mem(($.$story_app_battle_field.prototype), "EndTurn"));
	($.$story_app_battle_field_cell) = class $story_app_battle_field_cell extends ($.$mol_button_minor) {
		x(){
			return 0;
		}
		y(){
...
var $;
(function ($) {
    $mol_style_attach("story/app/battle/field/field.view.css", "[story_app_battle_field_cell]{\n\twidth: 60px;\n\theight: 60px;\n\tbackground-image: url(https://w7.pngwing.com/pngs/1020/831/png-transparent-gray-surface-illustration-mixed-martial-arts-heavyweight-octagon-boxing-rings-combat-mma-fight-flyer-angle-rectangle-sports.png);\n\tbackground-size: cover;\n\tbackground-position: center;\n}\n\n[story_app_battle_field_cell][active='true'] {\n\tbox-shadow: 0 0 10px red;\n}\n\n[story_app_battle_field_cell][type='hero'] {\n\tbackground-color: lightblue;\n}\n\n[story_app_battle_field_cell][type='enemy'] {\n\tbackground-color: lightpink;\n}\n\n");
})($ || ($ = {}));

;
	($.$story_app_battle) = class $story_app_battle extends ($.$mol_page) {
		title(){
			return "Поле битвы";
		}
		body(){
			return [(this.Search_battle()), (this.Field())];
		}
		Search_battle(){
			const obj = new this.$.$mol_button_major();
	...
	($mol_mem(($.$story_app_battle.prototype), "Search_battle"));
	($mol_mem(($.$story_app_battle.prototype), "Field"));
...
;
	($.$story_app) = class $story_app extends ($.$mol_book2_catalog) {
		menu_title(){
			return "История";
		}
		param(){
		...
		menu_foot(){
			return [(this.GitHub()), (this.Telegram())];
		}
		Spread_default(){
		...
		Auth(){
			const obj = new this.$.$story_app_auth();
			return obj;
		}
		Inventory(){
			const obj = new this.$.$mol_page();
	...
	($mol_mem(($.$story_app.prototype), "Logout_icon"));
	($mol_mem(($.$story_app.prototype), "logout"));
	($mol_mem(($.$story_app.prototype), "Logout"));
	($mol_mem(($.$story_app.prototype), "GitHub"));
	($mol_mem(($.$story_app.prototype), "Telegram_icon"));
	($mol_mem(($.$story_app.prototype), "Telegram"));
	($mol_mem(($.$story_app.prototype), "Statistics_text"));
	($mol_mem(($.$story_app.prototype), "Statistics"));
	($mol_mem(($.$story_app.prototype), "Stats"));
	($mol_mem(($.$story_app.prototype), "Auth"));
	($mol_mem(($.$story_app.prototype), "Inventory"));
	($mol_mem(($.$story_app.prototype), "Relic"));
	($mol_mem(($.$story_app.prototype), "Settings"));
	($mol_mem(($.$story_app.prototype), "Player"));
	($mol_mem(($.$story_app.prototype), "Heroes_menu"));
	($mol_mem(($.$story_app.prototype), "Battle"));
	($mol_mem(($.$story_app.prototype), "Accept_quest"));
	($mol_mem(($.$story_app.prototype), "Quest"));
	($mol_mem(($.$story_app.prototype), "Accept_event"));
	($mol_mem(($.$story_app.prototype), "Event"));
	($mol_mem(($.$story_app.prototype), "Join_clan"));
	($mol_mem(($.$story_app.prototype), "Clan"));
	($mol_mem(($.$story_app.prototype), "Wiki"));
